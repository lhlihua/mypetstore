...
<div id="BackLink">
<a href="VeiwCategory?categoryId=${sessionScope.product.categoryId}">Return to ${sessionScope.product.categoryId}</a>
</div>
...
<table>
	...
	<c:forEach var="item" items="${sessionScope.itemList}">
		<tr>
			<td>
				<a href="VeiwItem?itemId=${item.itemId}">${item.itemId}</a>
			</td>
			<td>
