...
public class OrderDAOImpl implements OrderDAO {
    ...
    public List<Order> getOrdersByUsername(String username){
        ...
        try{
            ...
            PreparedStatement preparedStatement = connection.prepareStatement(GETORDERBYUSERNAME);
            preparedStatement.setString(1,username);
            ResultSet resultSet = preparedStatement.executeQuery();
            while(resultSet.next()){
                Order order = new Order();
                getResultSetIntoOrder(resultSet,order);
                orderList.add(order);
            }
    ...
    private void getResultSetIntoOrder(ResultSet resultSet , Order order) throws Exception{
